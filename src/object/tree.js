...
class Tree extends Persistable {
	 ...
	 * @param {Object}   meta
	 */
	addRelationship(type, relationshipIndividual1, relationshipIndividual2) {
		const relationship = new Relationship(this._nextRelationshipId++, type, relationshipIndividual1, relationshipIndividual2)
	...
	findRelationships(data) {
		return this.relationships.filter(relationship => {
			return (
				relationship.relationshipIndividual1.individual === data.individual
				||
				relationship.relationshipIndividual2.individual === data.individual
			)
		})
	}
